...
public final class ViewfinderView extends View {
    ...
    public void setZxingConfig(ZxingConfig config) {
        this.config = config;
        reactColor = config.getReactColor();
    }
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        maskColor = ContextCompat.getColor(getContext(), R.color.viewfinder_mask1);
    ...
    private void initPaint() {
        ...
        scanLinePaint.setColor(Color.parseColor("#489de7"));
    ...
    private void drawFrameBounds(Canvas canvas, Rect frame) {
        ...
        if (config.getFrameLineColor() != -1) {
            paint.setColor(config.getFrameLineColor());
