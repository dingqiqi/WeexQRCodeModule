...
//    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int pxDimension = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, 100,context.getResources().getDisplayMetrics());

            /*水平居中  偏上显示*/
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height) / 5 + pxDimension;
